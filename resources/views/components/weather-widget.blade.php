<div id="welcome-message" class="h-[650px] md:max-w-[700px] flex flex-col items-center justify-center text-center p-12 bg-white rounded-lg shadow-sm border border-gray-100 min-h-[400px]">
    ...
    <div class="relative z-10">
        ...
        <div class="flex flex-col items-center justify-between gap-8">
            <div class="flex items-center">
                <img id="widget-icon" src="" alt="Weather Icon"
                    class="w-28 h-28 md:w-56 md:h-56 drop-shadow-lg">
                <div class="ml-4">
